...
const CardLink: React.FC<CardLinkProps> = ({ imageSrc, title, data }) => (
  <div className="block bg-gray-50 dark:bg-transparent rounded-xl border dark:border-white border-gray-800 p-3 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10 hover:bg-pink-500/10">
